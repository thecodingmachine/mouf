...
<div class="alert">You cannot run Mouf's installer, the <code>mouf/no_commit/MoufUsers.php</code> file already exists.</div>

<p>If you want to reinstall Mouf, you should delete the <code>mouf/no_commit/MoufUsers.php</code> page and then refresh this page.</p>
